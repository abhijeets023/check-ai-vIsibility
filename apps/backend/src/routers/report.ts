...
class FileStorageService {
  async uploadReport(scanId: string, reportData: any): Promise<string> {
...
class PDFGenerationService {
  async generateReport(scanData: any): Promise<Buffer> {
  ...
  async generatePublicBadge(score: number): Promise<Buffer> {
